...
# opt$fastq_reads_file<-'/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zld_and_SuHw/analysis/1_processing/logs/fastq_counts/dme_suhw_acfc_2to3_nexus_1_raw_reads.txt'
# opt$bowtie2_statistics<-'/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zld_and_SuHw/analysis/1_processing/logs/bowtie_metrics/dme_suhw_acfc_2to3_nexus_1_bowtie2_stats.txt'
# opt$granges<-'/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zld_and_SuHw/analysis/1_processing/rdata/dme_suhw_acfc_2to3_nexus_1.granges.rds'
# opt$nexus_bam<-'/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zld_and_SuHw/analysis/1_processing/bam/dme_suhw_acfc_2to3_nexus_1.bam'

# opt$fastq_reads_file<-'/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zld_and_SuHw/analysis/1_processing/logs/fastq_counts/orer_zld_mbt_nexus_1_raw_reads.txt'
# opt$bowtie2_statistics<-'/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zld_and_SuHw/analysis/1_processing/logs/bowtie_metrics/orer_zld_mbt_nexus_1_bowtie2_stats.txt'
# opt$granges<-'/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zld_and_SuHw/analysis/1_processing/rdata/orer_zld_mbt_nexus_1.granges.rds'
# opt$nexus_bam<-'/l/Zeitlinger/ZeitlingerLab/Manuscripts/Zld_and_SuHw/analysis/1_processing/bam/orer_zld_mbt_nexus_1.bam'
...
uniqueness <- 1 - ((total_aligned_read_count-deduplicated_read_count) / deduplicated_read_count)
